                ...
                <div class="main-sidebar-loggedin">
                    <div class="app-sidebar__user">
                        <div class="dropdown user-pro-body text-center">
                            <div class="user-pic">
                                <img src="{{asset('')}}back/img/bilafto.jpg" alt="user-img" class="rounded-circle mCS_img_loaded">
                            </div>
                            <div class="user-info">
                ...
                <ul class="side-menu ">
                    ...
                    <li class="slide @if(in_array(''.$segment1.'',array('data_pengguna'))) is-expanded @endif">
                        ...
                        <ul class="slide-menu @if(in_array(''.$segment1.'',array('data_pengguna'))) open @endif">
                            ...
                            <li><a class="slide-item @if(in_array(''.$segment1.'',array('data_pengguna'))) active @endif" href="" title="Pengguna">Pengguna</a></li>
                        </ul>
                    </li>
