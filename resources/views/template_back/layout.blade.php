...
<body class="main-body app sidebar-mini ltr">
    ...
    <div class="main-footer ht-45">
      ...
      <span> Copyright © 2022 <a href="javascript:void(0);" class="text-primary">Intan</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0);"> Intan Nur'aeni </a> All rights reserved.</span>
      </div>
    </div>
    <!-- Footer closed -->
    </div>
